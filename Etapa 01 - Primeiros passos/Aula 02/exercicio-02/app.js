...
const realBestMovie = `${bestMovie.slice(0, 34)} "Moonlight"`
...
const nameCurso = 'walter white'

let newName = nameCurso.slice(0, 6).replace('w', 'W') + nameCurso.slice(6).replace('w', 'W') 
